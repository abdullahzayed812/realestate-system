...
export default function MyListingsScreen(): React.ReactElement {
  ...
  const { data, isLoading } = useQuery({
    ...
    placeholderData: {
      data: [
        {
          id: 'prop-001', titleAr: 'شقة فاخرة في برج العرب الجديدة',
          type: 'APARTMENT', listingType: 'SALE', status: 'ACTIVE',
          price: 850000, currency: 'EGP', area: 175,
          viewsCount: 4230, favoritesCount: 87, createdAt: '2026-01-15T00:00:00Z',
        },
        {
          id: 'prop-002', titleAr: 'فيلا عصرية للبيع',
          type: 'VILLA', listingType: 'SALE', status: 'ACTIVE',
          price: 4500000, currency: 'EGP', area: 520,
          viewsCount: 8720, favoritesCount: 215, createdAt: '2026-02-01T00:00:00Z',
        },
        {
          id: 'prop-007', titleAr: 'مكتب للإيجار',
          type: 'OFFICE', listingType: 'RENT', status: 'PENDING',
          price: 6000, currency: 'EGP', area: 120,
          viewsCount: 0, favoritesCount: 0, createdAt: '2026-05-14T00:00:00Z',
        },
      ],
    },
  });
          ...
          renderItem={({ item }) => {
            ...
            return (
              <View style={styles.card}>
                ...
                <Text style={styles.propertyTitle} numberOfLines={2}>{item.titleAr}</Text>
                <Text style={styles.propertyPrice}>
                  {new Intl.NumberFormat('ar-EG', { style: 'currency', currency: item.currency, maximumFractionDigits: 0 }).format(item.price)}
                </Text>
...
const styles = StyleSheet.create({
  ...
  emptyTitle: { fontSize: 18, fontWeight: '700', color: '#374151', marginTop: 16, marginBottom: 20 },
  addEmptyBtn: {

...
const styles = StyleSheet.create({
  ...
  propertyName: { fontSize: 15, fontWeight: '700', color: '#0f172a', textAlign: 'right', marginBottom: 10 },
  customerRow: { flexDirection: 'row-reverse', justifyContent: 'space-between', marginBottom: 6 },
  customerName: { fontSize: 13, fontWeight: '600', color: '#374151' },
  customerPhone: { fontSize: 13, color: '#64748b' },
  scheduleRow: { flexDirection: 'row-reverse', gap: 16, marginBottom: 8 },
  scheduleText: { fontSize: 13, color: '#475569' },
  messageText: { fontSize: 13, color: '#64748b', textAlign: 'right', fontStyle: 'italic', marginTop: 4, marginBottom: 4 },
  actions: { flexDirection: 'row-reverse', gap: 10, marginTop: 12, paddingTop: 12, borderTopWidth: 1, borderTopColor: '#f1f5f9' },
  confirmBtn: {

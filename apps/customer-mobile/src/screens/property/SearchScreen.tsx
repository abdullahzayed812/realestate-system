      ...
      >
        {TYPES.map((t) => (
          <TouchableOpacity
            ...
            onPress={() => { setTypeFilter(t.key); setPage(1); }}
          >
          ...
          <View style={styles.filterRow}>
            {LISTING_TYPES.map((lt) => (
              <TouchableOpacity
                ...
                onPress={() => { setListingFilter(lt.key); setPage(1); }}
              >
                <Text style={[styles.filterOptionText, listingFilter === lt.key && styles.filterOptionTextActive]}>
                  {lt.label}
                </Text>
              </TouchableOpacity>
            ))}
          ...
          <View style={styles.filterRow}>
            {SORT_OPTIONS.map((s) => (
              <TouchableOpacity
                ...
                onPress={() => { setSortBy(s.key); setPage(1); }}
              >
                <Text style={[styles.filterOptionText, sortBy === s.key && styles.filterOptionTextActive]}>
                  {s.label}
                </Text>
              </TouchableOpacity>
            ))}
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingVertical: 12, backgroundColor: '#fff', gap: 10,
  ...
  searchBar: {
    ...
    backgroundColor: '#f1f5f9', borderRadius: 14, paddingHorizontal: 12, paddingVertical: 10, gap: 8,
  },
  ...
  typeFilter: { maxHeight: 52, paddingVertical: 8, backgroundColor: '#fff' },
  chip: {
  ...
  filterGroupLabel: { fontSize: 13, fontWeight: '700', color: '#374151', textAlign: 'right', marginBottom: 8, marginTop: 12 },
  ...
  priceRow: { flexDirection: 'row-reverse', gap: 10, alignItems: 'center' },
  priceInput: {
